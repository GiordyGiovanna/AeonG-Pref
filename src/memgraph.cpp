...
DEFINE_string(bolt_server_name_for_init, "",
              ...
              "Bolt INIT message.");
DEFINE_VALIDATED_int32(anchor_num, 11,
                       "Anchor num",
                       FLAG_IN_RANGE(0, std::numeric_limits<uint16_t>::max()));
...
// `mg_import_csv`. If you change it, make sure to change it there as well.
DEFINE_bool(storage_properties_on_edges, true, "Controls whether edges have properties."); //hjm begins before:false
...
int main(int argc, char **argv) {
  ...
  //hjm begin
  // db.saved_history_deltas_{data_directory/"history_deltas"};
  //hjm end
